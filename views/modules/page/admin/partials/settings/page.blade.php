...
<div class="row">
    <fieldset>
        ...
        <div class="col-md-3">
            {!! Form::normalSelect("settings[list_per_page]", "Sayfalama", $errors, array(''=>'Seçiniz') + array_combine(range(1, 24, 1), range(1, 24, 1)), isset($page->settings->list_per_page) ? $page->settings->list_per_page : 6) !!}
        </div>
        <div class="col-md-3">
...
@push('js-stack')
    {!! Asset::setDomain('//') !!}
    {!! Asset::add('themes/healthy/vendor/fonticonpicker/jquery.fonticonpicker.min.js') !!}
    {!! Asset::add('themes/healthy/vendor/fonticonpicker/css/jquery.fonticonpicker.min.css') !!}
    {!! Asset::add('themes/healthy/vendor/fonticonpicker/themes/bootstrap-theme/jquery.fonticonpicker.bootstrap.css') !!}
    {!! Asset::add('themes/healthy/fonts/iconmind/iconmind.css') !!}
    {!! Asset::css() !!}
    {!! Asset::js() !!}
    <script>
