<?php
namespace Themes\Healthy\Presenter;

use Nwidart\Menus\Presenters\Presenter;

class BottomMenuLinksPresenter extends Presenter
{
    /**
     * {@inheritdoc }.
     */
    ...
    {
        return PHP_EOL.'<ul class="list-inline bottom-link">'.PHP_EOL;
    }
    ...
    {
        return '<li><a href="'.$item->getUrl().'" '.$item->getAttributes().'>'.$item->getIcon().' '.$item->title.'</a></li>'.PHP_EOL;
    }
